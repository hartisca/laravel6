...
@section('box-content')
<div lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="card mb-3">
        <div class="cont333">
        <div class="cont444">
...
<form  method="POST" action="{{ route('places.unfav', $place) }}"  >
        ...
        <button class="btn me-md-2" type="submit">
          ...
          <p class="card-text bg-1" >{{ $place->description }} </p>
...
=======
                <p class="small text-muted mb-0">{{ $place->updated_at }}</p>
>>>>>>> 30c94d53edba127400c67d871759dc4bc2fe7b40
...
=======
                <p class="small mb-0">{{ $place->updated_at }}</p>
>>>>>>> 30c94d53edba127400c67d871759dc4bc2fe7b40
